...
public class Reviews implements SearchClass{
    ...
    public Reviews() {
        searchWords.add("Review");
        List<String> url1 = new ArrayList<>();
        List<String> url2 = new ArrayList<>();
        urlsAndItemsToSelect.put("https://www.saucemagazine.com/category/reviews","article.article" );
    }
